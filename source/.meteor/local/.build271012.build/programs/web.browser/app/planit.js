...
Schemas.Select = new SimpleSchema({                                    // 125
  AddClass: {                                                          // 126
    type: String                                                       // 127
  }                                                                    //
});                                                                    //
                                                                       //
Template.select.helpers({                                              // 131
  options: function () {                                               // 132
    return [{                                                          // 133
      //optgroup: "AP Classes",                                        //
      options: [{ label: "P.E.", value: "P.E." }, { label: "P.E.", value: "P.E." }, { label: "P.E.", value: "P.E." }]
    }];                                                                //
  }                                                                    //
});                                                                    //
/////////////////////////////////////////////////////////////////////////
